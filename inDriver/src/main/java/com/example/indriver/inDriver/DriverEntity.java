...
public class DriverEntity {
    private static int NumOfDriver = 2;
        ...
        try {
            ...
            if (Email == null)
                sql = "INSERT INTO Driver (" +
                        "DriverUsername, DriverMobileNumber, DriverPassword, DriverNationalID, DriverLicenseNumber, DriverRatingID)" +
                        "VALUES ('" + Username + "','" + MobileNumber + "','" + Pass + "','" + NationalID + "','" + License + "','" + NumOfDriver + "');";
            else
                sql = "INSERT INTO Driver (" +
                        "DriverUsername ,DriverMobileNumber ,DriverEmail ,DriverPassword, DriverNationalID, DriverLicenseNumber, DriverRatingID)" +
