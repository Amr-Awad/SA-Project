...
public class ClientEntity {
        ...
        try {
            ...
            while (res.next()) {
                ...
                String sql5 = "Select * " +
                        ...
                        "where Client.ClientID = ClientOffers.ClientID and Offer.OfferID = ClientOffers.COfferID " + " and Client.ClientID = " + c.getID() + ";";
    ...
    public static Ride addRide(Ride r)
    {
        ...
        try {
            ...
            res2.next();
            r.setID(res2.getInt("max(RideID)"));
    ...
    public static void modifyRideInProgress(Ride r,Client c)
    {

        String sql = "UPDATE Client\n" +
                "   SET\n" +
                "       InRide = '"+c.isInRide()+"',\n" +
                "       RideInProgress = "+r.getID() +
                " WHERE\n" +
                "       ClientID ="+c.getID() +"\n";
